...
// this function takes two parameters. Creating the variable days allows us to store the key names of the object we pass as "stocks"
//this data is returned in the form of an array. From here, we are able to map it. We pass an anonymous function with its own parameter 'x' for our map argument. This enables us to return each indexed value through our map function over the desired input we ascribe to "values". 

function getNumber(stocks, values) {
